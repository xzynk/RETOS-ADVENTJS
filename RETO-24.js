...
El cuñado 🦹‍♂️, que se las sabe todas, me ha dicho que tenga cuidado porque el truco del JSON.stringify
puede no funcionar... ya que los árboles pueden ser el mismo pero el orden de representación de las ramas
izquierda y derecha puede ser inversa... */
...
function checkIsSameTree(treeA, treeB) {
  ...
  const tree1 = sumTree(treeA)
  const tree2 = sumTree(treeB)
